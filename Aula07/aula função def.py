...
def menu():
    ...
    while opcao != 0:
        ...
        print('25 - função cinco perguntas')
        print("26 - função calculo do preço da gasolina")
        print('27 - função calculo do preço da fruto')
        print('28 - função cartão tabajara')
        ...
        if opcao == 1:
            ...
            print('--- inciando a função 5 perguntas')
            cinco_perguntas()
        elif opcao == 26:
            print('---iniciando a função calculo do litro de gasolina ')
            litros_combustivel()
        elif opcao == 27:
            print('--- iniciando a função calculo do preço da fruta')
            preco_frutas()
        elif opcao ==28:
            print('--- inicinaod a função cartão bajara')
            cartao_tabajara()
